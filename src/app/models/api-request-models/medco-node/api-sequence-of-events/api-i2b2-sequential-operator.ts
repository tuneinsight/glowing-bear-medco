 ...
 */
import { ApiI2b2When } from './api-i2b2-when';
...
export class ApiI2b2SequentialOperator {
  ...
  clone(): ApiI2b2SequentialOperator {
    let val = new ApiI2b2SequentialOperator()
