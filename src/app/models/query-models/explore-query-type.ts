export class ExploreQueryType {
  ...
  static readonly GLOBAL_COUNT = new ExploreQueryType('global_count', 20, 'Global count');
  static readonly GLOBAL_COUNT_OBFUSCATED =
  ...
  static readonly ALL_TYPES = [
    ...
    ExploreQueryType.GLOBAL_COUNT,
    ExploreQueryType.GLOBAL_COUNT_OBFUSCATED
  ];
